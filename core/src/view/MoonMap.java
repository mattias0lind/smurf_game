...
public class MoonMap {
    ...
    public void drawMap(SpriteBatch sb){
        ...
        sb.draw(moonStone, mapModel.getPlattForm1().getPosX()-40,mapModel.getPlattForm2().getPosY()-18, mapModel.getPlattForm1().getWidth()+104,mapModel.getPlattForm1().getHeight()+84);
